# == Class: yakshed::certificates
#
# Full description of class yakshed::certificates here
#
# === Parameters
#
...
#
class yakshed::certificates($hosts = {}){
  package {'ca-certificates':
    ensure => present
  }

  create_resources('yakshed::certificate', $hosts)
}
